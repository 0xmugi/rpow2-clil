...
// interactive bot responses: short timeout (5s) and few retries (2) so
// /status returns within ~10s worst case even when api.rpow2.com is sick.
async function fetchMeWithRetry(state, retries = 2, perAttemptTimeoutMs = 5000) {
  let lastErr;
